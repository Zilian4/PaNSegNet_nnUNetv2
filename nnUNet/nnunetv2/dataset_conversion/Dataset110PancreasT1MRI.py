...
def convert_pancreas_t1_dataset(input_dir, mask_dir=None, nnunet_dataset_id: int = 110):
    """
    Convert Pancreas T1 MRI segmentation dataset to nnU-Net format.
    ...
    Args:
        ...
        nnunet_dataset_id: nnU-Net Dataset ID, default: 110
    """
    task_name = "PancreasT1MRI"
    ...
    dataset_json = {
        ...
        "reference": "n/a",
        "release": "1.0",
        "description": "Pancreas T1 MRI Segmentation Dataset: Single-channel T1 MRI images with pancreas masks. Background=0, Pancreas=1.",
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input_dir', type=str, default='/data2/pyq6817/Pansegnet_data_raw/T1',
                        help="Path to the dataset directory. Can contain 'images'/'masks' subdirectories or directly contain image files. Default: /data2/pyq6817/Pansegnet_data_raw/T1")
    ...
    parser.add_argument('-d', required=False, type=int, default=110, 
                        help='nnU-Net Dataset ID, default: 110')
    args = parser.parse_args()
    convert_pancreas_t1_dataset(args.input_dir, args.mask_dir, args.d)
