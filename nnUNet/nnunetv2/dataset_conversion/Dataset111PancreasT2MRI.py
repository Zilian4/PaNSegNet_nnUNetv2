...
def convert_pancreas_t2_dataset(input_dir, mask_dir=None, nnunet_dataset_id: int = 111):
    """
    Convert Pancreas T2 MRI segmentation dataset to nnU-Net format.
    ...
    Args:
        ...
        nnunet_dataset_id: nnU-Net Dataset ID, default: 111
    """
    task_name = "PancreasT2MRI"
    ...
    dataset_json = {
        ...
        "reference": "n/a",
        "release": "1.0",
        "description": "Pancreas T2 MRI Segmentation Dataset: Single-channel T2 MRI images with pancreas masks. Background=0, Pancreas=1.",
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input_dir', type=str, default='/data2/pyq6817/Pansegnet_data_raw/T2',
                        help="Path to the dataset directory. Can contain 'images'/'masks' subdirectories or directly contain image files. Default: /data2/pyq6817/Pansegnet_data_raw/T2")
    ...
    parser.add_argument('-d', required=False, type=int, default=111, 
                        help='nnU-Net Dataset ID, default: 111')
    args = parser.parse_args()
    convert_pancreas_t2_dataset(args.input_dir, args.mask_dir, args.d)
